...
public class FrameManagership extends JFrame implements ActionListener, KeyListener {
	private static final long serialVersionUID = 2923975805665801740L;
	private static final int NUM_NAVI = 10;
	LinkedList<int[]> playerShips;// content le navi insert,serve per
									// costumire la frameBattle
	boolean finite = false;
	int naveInsert = 0;
	int[] counterShip = { 1, 2, 3, 4 };
	Mappa mappa;
	battleship.ui.UIManagePanel choosePan;
	battleship.ui.UIMapPanel mapPanel;

	public FrameManagership() {
		super("Battaglini Naval - Pirate Edition");
		mappa = new Mappa();
